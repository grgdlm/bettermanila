 ...
 * Labels live under `notFound.*` in the locale files.
 */
const SECTIONS = [
  {
    icon: Compass,
    labelKey: 'notFound.allServicesLabel',
    noteKey: 'notFound.allServicesNote',
    href: '/services',
  },
  {
    icon: Building2,
    labelKey: 'notFound.governmentLabel',
    noteKey: 'notFound.governmentNote',
    href: '/government',
  },
];
